...
const Workcard = ({ item }) => {
    return (
        <a className='w-[100%] h-[200px]' target='blank' href={`https://${item.git_url.slice(6)}`}>
            <article className='border  border-gray-600 hover:bg-gray-800 transition cursor-pointer hover:text-white rounded-lg px-8 py-5 flex flex-col gap-1 justify-center'>
